...
namespace Math_Quiz
{
    public partial class Form1 : Form
    {
        ...
        //These variables store the numbers for the subtraction problem.
        int minuend;
        int subtrahend;

        //These varialbes store the numbers for multiplication.
        int multiplicand;
        int multiplier;

        //These varialbes store the numbers for division.
        int dividend;
        int divisor;
